...
This project offers an introduction to JavaScript, web JQuery library. The aim is to have an understanding how we can use it to manipulate HTML elements.
